...
//            out.println("<html>");
//            out.println("<head>");
//            out.println("<title>Servlet RemoveBookingController</title>");            
//            out.println("</head>");
//            out.println("<body>");
//            out.println("<h1>Servlet RemoveBookingController at " + request.getContextPath() + "</h1>");
//            out.println("</body>");
//            out.println("</html>");
//        }
    }
